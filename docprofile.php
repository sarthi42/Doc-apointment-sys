...
<div class="content">
  ...
  <div class="col-lg-12 text-center">
       <h1 style="font-family:Lucida Console"><center>Create Doctor Profile</center></h1>
   </div>
   ...
   <form method="post" id="new-appointment">
		...
		<div class="input-field">
			 ...
			 if(isset($_POST['submit7']))
			 {
				 ...
				 $query = "SELECT * FROM doctor WHERE doc_id = '$docid' AND h_code = '$_SESSION[hospital_id]' AND availability = 'processing'";
				 ...
				 if(mysqli_num_rows($result) == 1)
				 {
						...
						// echo "already exist";
						 ...
						 if($result1 == true)
						 {
							 $query2 = "INSERT INTO doc_hospital(doc_id,h_code,shift,availability) VALUES('$docid','$_SESSION[hospital_id]','$shift','$avlblty')";
				 ...
				 else
					 {
						 ...
						 echo "<p class='error'>Already available</p>";
						 //echo '<META HTTP-EQUIV="Refresh" Content="0; URL=docprofile.php">';
					 }
...
function timedMsg()
{
var t=setTimeout("alert('10 seconds!')",5000);
}
</script>
</html>